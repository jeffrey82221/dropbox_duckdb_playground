...
class MetaGraph:
    ...
    """
    def __init__(self, subgraphs: Dict[str, Tuple[str, str]], node_grouping: Dict[str, List[str]], link_grouping: Dict[str, List[str]], input_ids: List[str], node_sqls: Dict[str, str], link_sqls: Dict[str, str]):
